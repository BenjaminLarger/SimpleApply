...
import { fillSuccessFactorsForm } from './adapters/successfactors.js';
...
export async function fillForm(
  ...
  // Dispatch to SuccessFactors adapter for SF-specific form sections
  await fillSuccessFactorsForm(root, profile);
}
